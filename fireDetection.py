...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "joshidhairya95@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("joshidhairay95@gmail.com", 'SPEEDISGOOD1') # Senders mail ID and password
        server.sendmail('joshidhairya95@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
